...
public class BelezaNaWebExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(final NoHandlerFoundException ex,
		...
		final ApiError apiError = new ApiError(HttpStatus.NOT_FOUND.value(), error);
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
		...
		final ApiError apiError = new ApiError(HttpStatus.METHOD_NOT_ALLOWED.value(), builder.toString());
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(final HttpMediaTypeNotSupportedException ex,
		...
		final ApiError apiError = new ApiError(HttpStatus.UNSUPPORTED_MEDIA_TYPE.value(),
	...
	public ResponseEntity<Object> handleCpfValidationException(final ProdutoException ex,
			final WebRequest request) {
		logger.info(ex.getClass().getName());

		final ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST.value(),
				String.format("cpf: cpf incorreto (%s)", ex.getMessage()));
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), HttpStatus.BAD_REQUEST);
	}
}